...
function createCloudControls(params = {}, disabled) {
    ...
    return [
        ...
        },
        {
            ...
            disabled: off,
            tooltip: '越大越清晰但越耗 GPU（流畅约 144 / 均衡约 220 / 极致 340）',
        },
        {
            ...
            disabled: off,
            tooltip: '颗粒感核心参数：越接近 100% 越细腻，GPU 像素成本也越高',
        },
        {
            id: 'minStepSize',
            label: '最小采样步长',
            ...
            disabled: off,
            tooltip: '越小越细腻、越少颗粒，但 raymarch 步数和 GPU 压力会上升',
        },
        {
            ...
            disabled: off,
            tooltip: '值越接近 1.000，远处采样越密、颗粒感越弱，但性能成本更高',
        },
        {
