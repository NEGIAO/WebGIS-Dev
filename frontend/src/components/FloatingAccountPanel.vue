                        ...
                        >
                            <div class="pref-list">
                                <div class="pref-item">
                                    <div class="pref-info">
                                        <span class="pref-title"
                                            ><i class="fas fa-moon"></i> 深色模式</span
                                        >
                                ...
                                <div class="pref-item">
                                    <div class="pref-info">
                                        <span class="pref-title"
                                            ><i class="fas fa-bell"></i> 系统通知</span
                                        >
...
.account-panel {
    ...
    box-shadow:
        ...
        inset 0 0 24px rgba(91, 207, 137, 0.15);
...
.stat-box:hover {
    ...
    box-shadow:
        ...
        0 6px 16px rgba(91, 207, 137, 0.15);
}
