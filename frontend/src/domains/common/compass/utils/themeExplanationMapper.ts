...
import polygonExplanationData from '@common/compass/svg/Explanation/polygon_explanation.json';
import compassExplanationData from '@common/compass/svg/Explanation/compass_explanation.json';
import circleExplanationData from '@common/compass/svg/Explanation/circle_explanation.json';
import darkExplanationData from '@common/compass/svg/Explanation/dark_explanation.json';
import simpleExplanationData from '@common/compass/svg/Explanation/simple_explanation.json';
 ...
 */
export function getThemeExplanation(themeIdentifier?: string | number): ThemeExplanationConfig {
    if (!themeIdentifier) {
 ...
 * @returns 对应的主题解释配置
 */
export function getThemeExplanationByConfig(config?: any): ThemeExplanationConfig {
