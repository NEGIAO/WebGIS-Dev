...
function waitForInitialSceneReady({ timeoutMs = 60000 } = {}) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const cleanup = () => {
            ...
            if (cancelInitialSceneWait === cancelWait) cancelInitialSceneWait = null;
        };
        ...
        cancelInitialSceneWait = cancelWait;
