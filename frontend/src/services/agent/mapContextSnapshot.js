import { BASEMAP_PRESETS, URL_LAYER_OPTIONS } from '@/constants/basemap/basemapPresets';
import { decodeCesiumCameraState, decodeCesiumPoseState } from '@/utils/url/crypto';
import { MAP_VIEW_CESIUM, MAP_VIEW_OL, normalizeMapView } from '@/utils/url/urlConstants';
import { getCurrentQuerySnapshot } from '@/utils/url/urlQueryReader';
